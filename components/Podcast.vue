<template>
  <article class="r_podcast">
    <header class="r_podcast__header has-background-light">
      <div class="r_podcast__cover has-background-dark"></div>
      <div class="r_podcast__title">
        <h1 class="is-size-5">Logbuch:Netzpolitik</h1>
        <h2 class="is-size-7">
